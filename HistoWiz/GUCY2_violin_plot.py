# -*- coding: utf-8 -*-
"""
Created on Wed Oct 13 12:43:28 2021
...
import winsound
#%% read data
txt_folder_path=r'C:\Users\Mark Zaidi\Documents\QuPath\HistoWiz\15643\GUCY2\TMA'
figpath=r'C:\Users\Mark Zaidi\Documents\QuPath\HistoWiz\15643\GUCY2\TMA\figures'
...
for txt_path,name in zip(filelist,file_part_2):
    ...
    for row in rows:
        ...
        ax = sns.boxplot(x="TMA core",y="Cell: DAB OD mean", data=curr_data)
